...
static const struct nl_policy tunnel_key_policy[TCA_TUNNEL_KEY_MAX +1] = {
...
static const struct nl_policy gact_policy[TCA_GACT_MAX + 1] = {
...
static const struct nl_policy mirred_policy[TCA_GACT_MAX + 1] = {
...
static const struct nl_policy stats_policy[TCA_STATS_MAX +1] = {
...
__nl_msg_put_flower_tunnel(struct ofpbuf *request, struct tc_flow *tc_flow)
{
    ...
    /* ovs_be16 tp_src = tc_flow->tunnel.tp_src; */
